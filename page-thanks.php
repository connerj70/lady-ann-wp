...
?>
	...
	<div style="display: flex; align-items: center; justify-content: center; width: 100%; padding-top: 80px; flex-direction: column;">
		<img style="width: 350px;" src="<?php bloginfo('template_url'); ?>/assets/faded-logo.svg" />
		<h1 style="margin-bottom: 10px; margin-top: 80px; font-size: 50px; font-family: sans-serif; font-weight: 100;">Thanks For Sharing!</h1>
